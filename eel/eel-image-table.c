...
static void    signal_connect_while_realized        (GObject            *object,
    						     const char         *name,
    						     GCallback           callback,
...
eel_image_table_realize (GtkWidget *widget)
{
    ...
    signal_connect_while_realized (G_OBJECT (windowed_ancestor),
    				   "enter_notify_event",
 ...
 **/
static void
signal_connect_while_realized (GObject *object,
    				const char *name,
    				GCallback callback,
    				gpointer callback_data,
    				GtkWidget *realized_widget)
