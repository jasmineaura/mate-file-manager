...
static void
caja_x_content_bar_set_x_content_types (CajaXContentBar *bar, const char **x_content_types)
{
    char *message = NULL;
    guint num_types;
    guint n;
                                 ...
                                 GParamSpec   *pspec)
{
    ...
    case PROP_X_CONTENT_TYPES:
        caja_x_content_bar_set_x_content_types (bar, g_value_get_boxed (value));
        break;
    default:
